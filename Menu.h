...
static constexpr int MAX_LEVELS_IN_MENU = 3;
...
class Menu {
    ...
    const char* instructions[MAX_Y] = {
        ...
        // 01234567890123456789012345678901234567890123456789012345678901234567890123456789
          ...
          "         - Use the key S to stay, X to get down on a ladder,                    ", // 13
          "           and P to use hammer.                                                 ", // 14
          "         - Press ESC to pause the game.                                         ", // 15
    ...
    const char* invalidScreen[MAX_Y] = {
    ...
    const char* invalidLastScreen[MAX_Y] = {
...
public:
    ...
    void printChooseLevel(std::vector<std::string>& vec_to_fill, int start);
    void printinvalidScreen();
    void printinvalidLastScreen();
};
